  ...
  const rawBuyCandidates = [
    ...latest.promisingSectors.flatMap((sector) =>
      sector.stocks
        ...
        .map((stock) => ({
          ...
          signalTiming: stock.signalTiming,
          entryQuality: stock.entryQuality,
          moveAlreadyHappenedPct: stock.moveAlreadyHappenedPct,
          high52wDistancePct: stock.high52wDistancePct,
    ...
    ...(latest.smallCapIdeas ?? [])
      ...
      .map((idea) => ({
        ...
        signalTiming: idea.signalTiming,
        entryQuality: idea.entryQuality,
        moveAlreadyHappenedPct: idea.moveAlreadyHappenedPct,
        high52wDistancePct: idea.high52wDistancePct,
        thesis: idea.thesis,
